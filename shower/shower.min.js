...
!function (a) {
    ...
    a.shower = {
        ...
        a.shower.modules.require("shower.defaultOptions", function (d) {
            var e = a.hasOwnProperty("showerOptions"), f = a.shower.options, g = f.shower_selector || d.container_selector, h = document.querySelector(g), i = b.bind(this, h), j = "undefined" == typeof f.auto_init || f.auto_init;
    ...
    b(c.prototype, {
        on: function (a, b, c) {
            if (Array.isArray(a))for (var d = 0, e = a.length; d < e; d++)this._listeners.push(a[d], b, c); else this._listeners.push(a, b, c);
            return this.events.on(a, b, c), this
        }, off: function (a, b, c) {
            if (Array.isArray(a))for (var d = 0, e = a.length; d < e; d++)this._removeListener(a[d], b, c); else this._removeListener(a, b, c);
            return this
        }, offAll: function () {
            for (var a = 0, b = this._listeners.length; a < b; a += 3)this.events.off(this._listeners[a], this._listeners[a + 1], this._listeners[a + 2]);
            return this._listeners.length = 0, this
        }, _removeListener: function (a, b, c) {
            for (var d = this._listeners.indexOf(a, 0); d != -1;)this._listeners[d + 1] == b && this._listeners[d + 2] == c && (this._listeners.splice(d, 3), this.events.off(a, b, c)), d = this._listeners.indexOf(a, d)
        }
    }), a(c)
    ...
    d(e.prototype, {
        on: function (a, b, c, d) {
            ...
            if (d = d || 0, "string" == typeof a)this._addListener(a, b, c, d); else for (var e = 0, f = a.length; e < f; e++)this._addListener(a[e], b, c, d);
            return this
        }, off: function (a, b, c, d) {
            if (d = d || 0, "string" == typeof a)this._removeListener(a, b, c, d); else for (var e = 0, f = a.length; e < f; e++)this._removeListener(a[e], b, c, d);
            return this
            ...
            if (f) {
                for (var g = -1, h = 0, i = f.length; h < i; h++)e = f[h], e.callback == b && e.context == c && e.priority == d && (g = h);
                g != -1 && (1 == f.length ? this._clearType(a) : f.splice(g, 1))
            }
    ...
    c(d.prototype, {
        destroy: function () {
            ...
            if (d && b)for (var e = 0, f = this._instances.length; e < f; e++) {
    ...
    d(e.prototype, {
        init: function () {
            ...
            if (this._shower.isHotkeysEnabled())switch (a.which) {
                case 13:
                    if (a.preventDefault(), !this.isSlideMode() && a.metaKey) {
                        var b = a.shiftKey ? 0 : this._shower.player.getCurrentSlideIndex();
                        this._shower.player.go(b), this.enterSlideMode()
                    } else a.shiftKey ? this._shower.player.prev() : this._shower.player.next();
                    break;
                case 27:
    ...
    j(k.prototype, {
        destroy: function () {
            ...
            if (Array.isArray.call(null, a))for (var b = 0, c = a.length; b < c; b++)this._addSlide(a[b]); else this._addSlide(a);
            return this
        }, remove: function (a) {
            var b;
            if ("number" == typeof a)b = a; else {
                if (this._slides.indexOf(a) == -1)throw new Error("Slide not found");
    ...
    d(e.prototype, {
        destroy: function () {
            ...
            this._isSlideMode() && e === -1 ? b.player.go(0) : e === -1 && "" !== window.location.hash && b.player.go(0), d && c !== d.getId() && (a = this._getSlideById(c), b.player.go(a.index))
        }, _setTitle: function () {
    ...
    d(e.prototype, {
        init: function () {
            this._showerListeners = this._shower.events.group().on("slideadd", this._onSlideAdd, this).on("slideremove", this._onSlideRemove, this).on("slidemodeenter", this._onSlideModeEnter, this), this._playerListeners = this.events.group().on("prev", this._onPrev, this).on("next", this._onNext, this), document.addEventListener("keydown", c(this, "_onKeyDown"))
        }, destroy: function () {
            ...
            return a != this._currentSlideNumber && a < b && a >= 0 && (c && c.isActive() && c.deactivate(), c = this._shower.get(a), this._currentSlide = c, this._currentSlideNumber = a, c.isActive() || c.activate(), this.events.emit("activate", {
                index: a,
                slide: c
            })), this
    ...
    function c(a) {
        this._data = a || {};
        for (var c = 1, d = arguments.length; c < d; c++)b(this._data, arguments[c] || {})
    }
    ...
    function e(a, b) {
        b = b || {}, this.events = new c({context: this}), this._shower = a, this._elementsSelector = b.selector || g, this._elements = [], this._innerComplete = 0, this._setupListeners(), this._shower.player.getCurrentSlideIndex() != -1 && this._onSlideActivate()
    }
    ...
    d(e.prototype, {
        destroy: function () {
            ...
            b && c < b && c > 0 && (a.preventDefault(), this.prev())
        }, _go: function () {
            for (var a = 0, b = this._elements.length; a < b; a++) {
    ...
    d(e.prototype, {
        destroy: function () {
            ...
            }, this)), a.player.getCurrentSlideIndex() != -1 && this._onSlideActivate()
        }, _clearListeners: function () {
            ...
            if (this._shower.container.isSlideMode() && a.state.get("visited") < 2) {
                ...
                b && /^(\d{1,2}:)?\d{1,3}$/.test(b) && (b.indexOf(":") !== -1 ? (b = b.split(":"), b = 1e3 * (60 * parseInt(b[0], 10) + parseInt(b[1], 10))) : b = 1e3 * parseInt(b, 10), 0 !== b && this._initTimer(b))
            }
    ...
    b(c.prototype, {
        destroy: function () {
            ...
            for (var b = this._shower.getSlides(), c = null, d = 0, e = b.length; d < e; d++)if (a.id === b[d].getId()) {
